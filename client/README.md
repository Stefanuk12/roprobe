...
The associated client for roprobe. Built from the [script-template](https://github.com/rocult/script-template) (`pesde-8`) layout.
...
2. Run `mise install` and `mise install-darklua` while `cd` in this (`client`) directory
...
3. Run `mise build`, **from this directory**
