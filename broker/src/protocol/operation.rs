...
#[derive(
    Clone, Eq, PartialEq, Ord, PartialOrd, Hash, Debug, Default, Serialize, ReverseDeserialize,
)]
...
mod tests {
    ...
    fn operations_round_trip() {
        let cases = vec![
            ...
            Operation::GetProperties {
                node: "n".into(),
                properties: vec!["Anchored".into(), "Name".into()],
            },
            Operation::RunCode {
        ...
        let cases = vec![
            ...
            OpResult::Reads(Reads {
                properties: vec![
                    ...
                    NamedValue {
                        name: "PrimaryPart".into(),
                        value: DomValue::Ref("ref".into()),
                    },
                    NamedValue {
                        name: "Shape".into(),
                        value: DomValue::Enum(3, 1),
                    },
                ],
                tags: vec!["Enemy".into()],
    ...
    fn operation_wire_layouts_are_pinned() {
        ...
        assert_eq!(
            (Operation::RunCode { source: "s".into() })
                .to_bytes()
                .unwrap(),
            vec![b's', 1, 11]
        );
